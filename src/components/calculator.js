    ...
    return (
      <div>
        ...
        <div className="buttons">
          ...
          <button type="button" id="%" className="button" onClick={() => this.handleClick('%')}>%</button>
          <button type="button" id="&divide;" className="operator-color" onClick={() => this.handleClick('÷')}>÷</button>
          ...
          <button type="button" id="&times;" className="operator-color" onClick={() => this.handleClick('x')}>x</button>
          ...
          <button type="button" id="-" className="operator-color" onClick={() => this.handleClick('-')}>-</button>
